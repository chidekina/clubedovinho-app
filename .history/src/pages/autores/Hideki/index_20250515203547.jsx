...
const Hideki = () => {
    ...
    useEffect(() => {
        ...
        let url = `https://servicodados.ibge.gov.br/api/v1/localidades/regioes/${id}/estados`;
        ...
        <div id="container">
            ...
            <div id="regions">
                ...
                <select id="region-select" onChange={(e) => console.log(e.target.value)}>
                    {regions.map(regiao=> <option key={regiao.id} value={regiao.id}>{regiao.nome}</option>)}
                </select>
                <select>
                    {}
                </select>
